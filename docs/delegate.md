...
See the [latest targeted results](completion-remediation-live.md) and [local repair checks](completion-remediation.md). Earlier campaign results remain historical evidence for their recorded source revisions.
...
- [Test-readiness changes and measurement protocol](test-readiness-2026-09-13.md)
- [Skill instructions and routing policy](../skills/delegate/SKILL.md)
- [Interactive system map](delegate-system.html)
- [Deterministic routing policy and checklist](deterministic-routing-refinement.md)
- [Latest targeted live checks](completion-remediation-live.md)
- [Historical evaluation notes](delegate-ordinary-results-2026-09-11.md)
- [Validation record](validation-status.md)
- [Model Governor](model-governor-spec.md)
