...
Exact copy commands for a fresh installation are in the [manual installation guide](install.md#manual-install). Host-specific execution guidance lives inside the installed folder at `hosts/claude-code.md` and `hosts/codex.md`.
