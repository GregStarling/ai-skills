...
export async function executeFrontier({target,directory,prompt,destination,timeoutMs=90000,write=false,environment=null}){
  ...
  const {env,overrideNames}=environment??nativeEnvironment(target.provider,candidate);
