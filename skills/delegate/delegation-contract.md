...
- **Execution:** actual model/effort controls; for evidence-required routing, retain the returned candidate and serving controls. Pack hashes belong in tracked receipts, not ordinary packets.
